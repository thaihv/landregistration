...
/**
 * Various methods to find process definitions by group and {@link com.lo.pckg.activiti.model.document.DocType}.
...
//        InputStream in = this.appContext.getResource("classpath:800x200.png").getInputStream();
     ...
     * @see {@link com.lo.pckg.activiti.workflow.WFConstants#NAMESPACE_CATEGORY}
     */
