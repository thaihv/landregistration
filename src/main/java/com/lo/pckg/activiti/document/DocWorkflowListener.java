package com.lo.pckg.activiti.document;

import com.lo.pckg.activiti.alert.AlertService;
import com.lo.pckg.activiti.model.Alert;
import com.lo.pckg.activiti.model.document.DocState;
import com.lo.pckg.activiti.model.document.Document;
...
public class DocWorkflowListener {
    ...
    /**
     * Task listener that runs when an {@link com.lo.pckg.activiti.model.task.TaskCollaborationForm} or
     * {@link com.lo.pckg.activiti.model.task.TaskApprovalForm} is created. Sets the candidate group to the document's group.
     *
     * @param execution
     * @param task
     */
