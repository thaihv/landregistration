<%@ tag import="com.lo.pckg.activiti.model.document.DocType" %>
...
<spring:eval expression="T(com.lo.pckg.activiti.workflow.WFConstants).TASK_ID_DOC_APPROVAL" var="docApprovalTask" />
<spring:eval expression="T(com.lo.pckg.activiti.workflow.WFConstants).TASK_ID_DOC_COLLABORATE" var="docCollaborateTask" />
<spring:eval expression="T(com.lo.pckg.activiti.workflow.WFConstants).TASK_ID_USER_APPROVAL" var="userApprovalTask" />
<spring:eval expression="T(com.lo.pckg.activiti.model.document.DocType).BOOK_REPORT" var="bookReportTypeStr" />
<spring:eval expression="T(com.lo.pckg.activiti.model.document.DocType).INVOICE" var="invoiceTypeStr" />
<c:choose>
